namespace laboratoriPizzeriaCampusExpress
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.buttonPedidosPremium = new System.Windows.Forms.Button();
        	this.SuspendLayout();
        	// 
        	// txtCliente
        	// 
        	...
        	// 
        	// buttonPedidosPremium
        	// 
        	this.buttonPedidosPremium.Location = new System.Drawing.Point(320, 315);
        	this.buttonPedidosPremium.Name = "buttonPedidosPremium";
        	this.buttonPedidosPremium.Size = new System.Drawing.Size(300, 23);
        	this.buttonPedidosPremium.TabIndex = 9;
        	this.buttonPedidosPremium.Text = "Nuevo Pedido Premium";
        	this.buttonPedidosPremium.UseVisualStyleBackColor = true;
        	this.buttonPedidosPremium.Click += new System.EventHandler(this.Button1Click);
        	// 
        	// MainForm
        	// 
        	...
        	this.Controls.Add(this.buttonPedidosPremium);
        ...
        private System.Windows.Forms.Button buttonPedidosPremium;
    }
}